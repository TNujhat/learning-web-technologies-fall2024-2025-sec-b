...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Retrieve files from the second page
...
<head>
    ...
    <style>
        ...
        header {
            background-color: #066f22; /* Green header background */
            color: white;
            padding: 20px;
            display: flex;
            align-items: center;
        ...
        #brtalogo {
            ...
            left: 20px; /* Distance from the left edge of the header */
        }

        #brtalogo img {
            width: 50px; /* Set the desired logo width */
